                ...
                <div class="card-body gradient-custom-3 p-5">
                  ...
                  <form>
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="password" placeholder='Enter Current Password' id="form3Example4cg" class="form-control form-control-lg" />
                    </div>

                    <div class="form-outline mb-4">
                      <label class="form-label" for="form3Example4cg">New Password</label>
                      <input type="password" placeholder='Enter New Password' id="form3Example4cg" class="form-control form-control-lg" />
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                      <button type="button" class="btn btn-Primary btn-block btn-lg text-body">Submit</button>
                    </div>
                    <div>

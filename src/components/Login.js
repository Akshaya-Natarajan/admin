            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 shadow-lg p-4 mb-4 bg-white gradient-custom-3 rounded-4 ">
              <form>
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                  <button type="button" onClick={handleSubmit} class="btn btn-primary btn-lg"
                  >Login</button>
                  <p class=" lb small fw-bold mt-2 pt-1 mb-0">Don't have an account?
                    <Link to={'/register'}><a href="#!" class="link-danger">Register</a></Link></p>
                </div>
